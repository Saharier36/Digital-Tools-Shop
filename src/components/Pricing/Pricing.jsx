...
const Pricing = () => {
  return (
    <div className="py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-11/12 max-w-7xl mx-auto gap-8 mt-12 px-2">
        ...
        <div className="card bg-base-100 shadow-sm">
          <div className="relative card-body space-y-6 bg-linear-to-r from-indigo-700 to-purple-600 text-white rounded-xl">
            <span className="absolute -top-4 left-1/2 -translate-x-1/2 text-[#BB4D00] bg-[#FEF3C6] rounded-full py-1 px-4 text-sm font-semibold">
              Most Popular
            </span>
            <div>
            ...
            <div className="pt-4">
              <button className="btn bg-white text-purple-600 rounded-full btn-block border-none hover:bg-gray-100">
                Start Pro Trial
              </button>
            </div>
          </div>
